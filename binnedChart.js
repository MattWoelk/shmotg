...
console.log("missing:" + bird.missingBins([0, 15], 0));
bird.addBinnedData(
    { average:
      {
        levels: [
...
console.log(_.pluck( bird.bd().rawData.levels[0], 'ms' ));
console.log(_.pluck( bird.bd().average.levels[1], 'ms' ));
console.log("missing:" + bird.missingBins([0, 40], 1));
bird.addBinnedData(
    { average:
      {
        levels: [
