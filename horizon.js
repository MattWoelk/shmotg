...
var redraw = function () {
  plots.forEach(function (plt) {
    plt.width(window.innerWidth).update();
  });
}
...
plot2 = horizonChart().width(window.innerWidth);
plot3 = horizonChart().width(window.innerWidth);
plot4 = horizonChart().width(window.innerWidth);
...
plot1.height(50).width(window.innerWidth);
