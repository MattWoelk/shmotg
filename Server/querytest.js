...
query =
'SELECT ESGgirder18 FROM SPBRTData_0A WHERE Time BETWEEN "2012-01-02 10:00:01" AND "2012-01-02 10:00:02" LIMIT 10';

//query = 'Show databases'
query = 'Show databases'
query = 'SELECT * FROM SPBRTData_Raw_AA LIMIT 10';
query = 'Show tables'
